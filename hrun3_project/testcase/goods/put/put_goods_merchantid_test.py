...
# FROM: testcase\goods\put\put_goods_merchantid.yml
...
class TestCasePutGoodsMerchantid(HttpRunner):
        ...
        Parameters(
            {
                "goodsname-goodscode-merchantid-code-msg": [
                    ...
                    [
                        "yoyo123",
                        "sp_test1",
                        "sp1aaaaaaaaabbbbbbbbbxxxxxxxxq222",
                        3003,
                        "参数不合法",
                    ],
                ]
...
if __name__ == "__main__":
    TestCasePutGoodsMerchantid().test_start()
