...
# FROM: testcase\goods\put\put_goods_goodsstatus.yml
...
class TestCasePutGoodsGoodsstatus(HttpRunner):
    @pytest.mark.parametrize(
        "param",
        Parameters(
            {
                "goodsname-goodscode-goodsstatus-code-msg": [
                    ["yoyo123", "sp_test1", None, 3003, "参数不合法"],
...
if __name__ == "__main__":
    TestCasePutGoodsGoodsstatus().test_start()
