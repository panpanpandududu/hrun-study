...
# FROM: testcase\goods\add\add_goods_goodsprice.yml
...
class TestCaseAddGoodsGoodsprice(HttpRunner):
        ...
        Parameters(
            {
                "goodsname-goodscode-goodsprice-code-msg": [
                    ...
                    ["yoyo123", "${goods_code()}", 19.1, 0, "success!"],
...
if __name__ == "__main__":
    TestCaseAddGoodsGoodsprice().test_start()
