...
# FROM: testcase\goods\add\add_goods_goodsstatus.yml
...
class TestCaseAddGoodsGoodsstatus(HttpRunner):
    @pytest.mark.parametrize(
        "param",
        Parameters(
            {
                "goodsname-goodscode-goodsstatus-code-msg": [
                    ["yoyo123", "${goods_code()}", None, 3003, "参数不合法"],
...
if __name__ == "__main__":
    TestCaseAddGoodsGoodsstatus().test_start()
