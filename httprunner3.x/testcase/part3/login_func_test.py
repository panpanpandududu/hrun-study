...
# FROM: testcase\part3\login_func.yml
...
class TestCaseLoginFunc(HttpRunner):
    @pytest.mark.parametrize("param", Parameters({"user-psw": "${get_user_psw(5)}"}))
